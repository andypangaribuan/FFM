...
class StreamTuple8<T1, T2, T3, T4, T5, T6, T7, T8> {
  ...
  StreamTuple8(this.stream1, this.stream2, this.stream3, this.stream4, this.stream5, this.stream6, this.stream7, this.stream8);
}
...
class StreamInitialDataTuple8<T1, T2, T3, T4, T5, T6, T7, T8> {
  ...
  StreamInitialDataTuple8(this.data1, this.data2, this.data3, this.data4, this.data5, this.data6, this.data7, this.data8);
}
...
class SnapshotTuple8<T1, T2, T3, T4, T5, T6, T7, T8> {
  ...
  SnapshotTuple8(this.snapshot1, this.snapshot2, this.snapshot3, this.snapshot4, this.snapshot5, this.snapshot6, this.snapshot7, this.snapshot8);
}
...
class StreamBuilder8<T1, T2, T3, T4, T5, T6, T7, T8> extends StatelessWidget {
  ...
  const StreamBuilder8({Key? key, required this.streams, required this.initialData, required this.builder})
      : super(key: key);
                              ...
                              builder: (context, snap7) {
                                return StreamBuilder<T8>(
                                  ...
                                  builder: (context, snap8) {
                                    return builder(context, snap1, snap2, snap3, snap4, snap5, snap6, snap7, snap8);
                                  },
                                );
                              },
                            );
