...
class StreamInitialDataTuple2<T1, T2> {
  ...
  StreamInitialDataTuple2(this.data1, this.data2);
}
...
class StreamBuilder2<T1, T2> extends StatelessWidget {
  ...
  const StreamBuilder2({Key? key, required this.streams, required this.initialData, required this.builder})
      : super(key: key);
      ...
      builder: (context, snap1) {
        return StreamBuilder<T2>(
          ...
          builder: (context, snap2) {
            return builder(context, snap1, snap2);
          },
        );
      },
    );
