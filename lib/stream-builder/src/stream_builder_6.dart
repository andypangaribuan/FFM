...
class StreamTuple6<T1, T2, T3, T4, T5, T6> {
  ...
  StreamTuple6(this.stream1, this.stream2, this.stream3, this.stream4, this.stream5, this.stream6);
}
...
class StreamInitialDataTuple6<T1, T2, T3, T4, T5, T6> {
  ...
  StreamInitialDataTuple6(this.data1, this.data2, this.data3, this.data4, this.data5, this.data6);
}
...
class SnapshotTuple6<T1, T2, T3, T4, T5, T6> {
  ...
  SnapshotTuple6(this.snapshot1, this.snapshot2, this.snapshot3, this.snapshot4, this.snapshot5, this.snapshot6);
}
...
class StreamBuilder6<T1, T2, T3, T4, T5, T6> extends StatelessWidget {
  ...
  const StreamBuilder6({Key? key, required this.streams, required this.initialData, required this.builder})
      : super(key: key);
                      ...
                      builder: (context, snap5) {
                        return StreamBuilder<T6>(
                          ...
                          builder: (context, snap6) {
                            return builder(context, snap1, snap2, snap3, snap4, snap5, snap6);
                          },
                        );
                      },
                    );
